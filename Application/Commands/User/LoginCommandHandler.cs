...
public class LoginCommandHandler : IRequestHandler<LoginCommand, AuthResponseDto>
{
    ...
    IJwtService jwtService, ILogger<LoginCommandHandler> logger, IEmailService emailService, 
    ...
    public async Task<AuthResponseDto> Handle(LoginCommand request, CancellationToken ct)
    {
        ...
        // ✅ Отправляем email
        await SendLoginNotificationEmailAsync(user, request, location, deviceInfo, ct);
